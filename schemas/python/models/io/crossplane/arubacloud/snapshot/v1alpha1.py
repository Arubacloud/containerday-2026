...
#   filename:  workdir/arubacloud_crossplane_io_v1alpha1_snapshot.yaml
...
class VolumeUriSelector(BaseModel):
    matchControllerRef: bool | None = None
    """
    MatchControllerRef ensures an object with the same controller reference
    as the selecting object is selected.
...
class ForProvider(BaseModel):
    ...
    """
    volumeUriRef: VolumeUriRef | None = None
    """
    Reference to a Blockstorage in arubacloud to populate volumeUri.
    """
    volumeUriSelector: VolumeUriSelector | None = None
    """
