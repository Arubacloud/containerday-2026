...
#   filename:  workdir/arubacloud_crossplane_io_v1alpha1_containerregistry.yaml
...
class PublicIpUriRefRef(BaseModel):
    name: str
    """
...
class PublicIpUriRefSelector(BaseModel):
...
class Network(BaseModel):
    ...
    """
    publicIpUriRefRef: PublicIpUriRefRef | None = None
    """
    Reference to a Elasticip in arubacloud to populate publicIpUriRef.
    """
    publicIpUriRefSelector: PublicIpUriRefSelector | None = None
    """
...
class Settings(BaseModel):
    ...
    """
    concurrentUsersFlavor: str | None = None
    """
...
class BlockStorageUriRefRef(BaseModel):
    name: str
    """
    Name of the referenced object.
    """
...
class BlockStorageUriRefSelector(BaseModel):
    matchControllerRef: bool | None = None
    """
    MatchControllerRef ensures an object with the same controller reference
    as the selecting object is selected.
...
class Storage(BaseModel):
    blockStorageUriRef: str | None = None
    """
    ...
    """
    blockStorageUriRefRef: BlockStorageUriRefRef | None = None
    """
    Reference to a Blockstorage in arubacloud to populate blockStorageUriRef.
    """
    blockStorageUriRefSelector: BlockStorageUriRefSelector | None = None
    """
