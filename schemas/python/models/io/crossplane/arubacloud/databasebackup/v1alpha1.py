...
#   filename:  workdir/arubacloud_crossplane_io_v1alpha1_databasebackup.yaml
...
class Databasebackup(BaseModel):
    ...
    """
    kind: Literal['Databasebackup'] | None = 'Databasebackup'
    """
...
class DatabasebackupList(BaseModel):
    ...
    """
    List of databasebackups. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md
    """
    kind: str | None = None
    """
    Kind is a string value representing the REST resource this object represents. Servers may infer this from the endpoint the client submits requests to. Cannot be updated. In CamelCase. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
