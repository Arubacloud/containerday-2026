...
#   filename:  workdir/arubacloud_crossplane_io_v1alpha1_restore.yaml
...
class BackupIdSelector(BaseModel):
...
class ForProvider(BaseModel):
    ...
    """
    backupIdRef: BackupIdRef | None = None
    """
    Reference to a Backup in arubacloud to populate backupId.
    """
    backupIdSelector: BackupIdSelector | None = None
    """
